...
# 24. Write a function that reads a file and returns its content.
def read_function():
    with open("practice.txt")as f:
        data =f.read()
    return data
...
#25. Write a function that reads a file containing numbers separated by commas
# (example: 10,20,30) and returns a list of integers.
def integers_list():
    with open('practice.txt') as f:
        data=f.read()
        s_data=data.split(',')
        ...
        for i in s_data:
            print(i)
            inter_value=int(i)
            lists.append(inter_value)
    return lists        
print(integers_list())

# 26. Write a function that counts how many words are in a text file.
...
# 27. Write a function that takes a list of numbers and returns the maximum number.
def maximum_num(lis):
    set_value=lis[0]
    for i in lis:
        if (i > set_value ):
...
# # 28. Write a function that takes a list and returns the sum of all elements.
def list_sum(li):
    print(li)
    sum_v=0
    for i in li:
...
# 29. Write a function that takes a string and counts how many vowels are in it.
def vowels(txt):
    s_txt=txt.split() 
    count=0
    for i in s_txt: 
        for v in i:
            print(v)
            if(v.lower() == 'a' or v.lower()=='e'or  v.lower()=='i' or v.lower()=='o' or v.lower()=='u'):
                count +=1
    print(count) 
    return count           
...
text="Hello World! I am learning Python."
print(vo(text))
# 30. Write a function that takes a number and checks whether it is prime.

# 31. Write a function that takes a list and returns a new list with only even numbers.